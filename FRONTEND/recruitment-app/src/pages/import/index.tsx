...
import { ChevronDown, ChevronUp, X, Upload, FileText } from "lucide-react";
import {
  FiltersContainer,
  FiltersHeader,
  FiltersTitle,
...
const ImportPage: React.FC = () => {
  const [activeTab, setActiveTab] =
    useState<'autres' | 'organigramme' | 'collaborateurs'>('organigramme');
  ...
  const tabTitles = [
    ...
    { key: 'autres' as const, label: 'Entités' },
      ...
      <FiltersContainer $isMinimized={isMinimized}>
        ...
        {!isMinimized && !isHidden && (
          <FiltersSection>
            ...
            {activeTab === 'autres' && (
              <>
                <FormLabelSearch>Fichier des entités (CSV)</FormLabelSearch>
                <FileUploadField
                  label="Entités"
                  accept=".csv"
...
const ProtectedImportPage: React.FC = () => (
  <ProtectedRoute requiredHabilitation="Accéder aux données">
    <ImportPage />
  </ProtectedRoute>
);

export default ProtectedImportPage;
