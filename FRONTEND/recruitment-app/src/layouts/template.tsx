...
const Template: React.FC<TemplateProps> = ({ children }) => {
  ...
  const hasVoirUtilisateurs = useHasHabilitation(user.userId, "Consulter les utilisateurs");
  const hasVoirDroitAcces = useHasHabilitation(user.userId, "Accéder au module Droit & Accès");
  const hasVoirAcces = useHasHabilitation(user.userId, "Consulter les rôles");
  const hasVoirReferentiel = useHasHabilitation(user.userId, "Accéder au référentiel");
  const hasVoirImport = useHasHabilitation(user.userId, "Accéder aux données");
...
// Vérification de l'accès 
  ...
  const generateBreadcrumbs = useCallback((): BreadcrumbItem[] => {
    ...
    // ADMIN - Utilisateurs
    else if (currentPath === "/utilisateurs") {
      breadcrumbs.push({
    ...
    // ADMIN - Habilitations
    else if (currentPath === "/habilitations") {
      breadcrumbs.push({
        title: "Administration",
        path: "/habilitations",
        isActive: false,
    ...
    else if (currentPath === "/referentiels") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: true,
    ...
    // RÉFÉRENTIEL - Directions
    else if (currentPath === "/referentiels/direction") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Directions",
        path: "/referentiels/direction",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Départements
    else if (currentPath === "/referentiels/department") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Départements",
        path: "/referentiels/department",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Services
    else if (currentPath === "/referentiels/service") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Services",
        path: "/referentiels/service",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Sites
    else if (currentPath === "/referentiels/site") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Sites",
        path: "/referentiels/site",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Genres
    else if (currentPath === "/referentiels/genders") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Genres",
        path: "/referentiels/genders",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Types de contrat
    else if (currentPath === "/referentiels/contract") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        ...
        path: "/referentiels/contract",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Unités
    else if (currentPath === "/referentiels/unit") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Unités",
        path: "/referentiels/unit",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Collaborateurs
    else if (currentPath === "/referentiels/collaborator") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        ...
        path: "/referentiels/collaborator",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Lieux
    else if (currentPath === "/referentiels/lieu") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Lieux",
        path: "/referentiels/lieu",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Transports
    else if (currentPath === "/referentiels/transport") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        title: "Transports",
        path: "/referentiels/transport",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Barèmes de compensation
    else if (currentPath === "/referentiels/compensation-scale") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
      ...
      breadcrumbs.push({
        ...
        path: "/referentiels/compensation-scale",
        isActive: true,
      });
    }
    
    // RÉFÉRENTIEL - Zones géographiques
    else if (currentPath === "/referentiels/geo-zone") {
      breadcrumbs.push({
        title: "Référentiel",
        path: "/referentiels",
        isActive: false,
