...
const UserList: React.FC = () => {
  ...
  const canModifyRoles = useHasHabilitation(userId, "Modifier les utilisateurs");
  const canDeleteRoles = useHasHabilitation(userId, "Modifier les utilisateurs");
...
const ProtectedUserList: React.FC = () => (
  <ProtectedRoute requiredHabilitation="Consulter les utilisateurs">
    <UserList />
  </ProtectedRoute>
);
