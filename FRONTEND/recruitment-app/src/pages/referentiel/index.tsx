...
import { ArrowLeft, Building2, Building, Settings, FileSignature, Users, MapPin } from "lucide-react";
...
const Referentiel: React.FC = () => {
  ...
  const handleNavigateToDirection = () => {
    navigate('/referentiels/direction'); 
  };

  const handleNavigateToDepartement = () => {
    navigate('/referentiels/department');
  };

  const handleNavigateToService = () => {
    navigate('/referentiels/service');
  };

  const handleNavigateToContract = () => {
    navigate('/referentiels/contract');
  };

  const handleNavigateToCollaborateur = () => {
    navigate('/referentiels/collaborator');
  };

  const handleNavigateToSite = () => {
    navigate('/referentiels/site');
  };
...
const ProtectedReferentiel: React.FC = () => (
  <ProtectedRoute requiredHabilitation="Accéder au référentiel">
    <Referentiel />
  </ProtectedRoute>
);

export default ProtectedReferentiel;
