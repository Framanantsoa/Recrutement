...
const RequestList: React.FC = () => {
  ...
  // Habilitations
  const canAddRequest = useHasHabilitation(userId, "Créer une demande");
  const canAddRegularisation = useHasHabilitation(userId, "Créer demande régularisation");
  const canViewDetails = useHasHabilitation(userId, "Consulter le détail d’une demande");
  const canEditRequest = useHasHabilitation(userId, "Modifier une demande");
  const canCancelRequest = useHasHabilitation(userId, "Supprimer une demande");
  const canViewAllRequests = useHasHabilitation(userId, "Consulter les demandes");
  const canViewCollaboratorRequests = useHasHabilitation(userId, "Consulter les demandes des collaborateurs");
